...
const nl_NL = {
  ...
  SCAN: {
    ...
    CONNECTION_REQUEST: {
      ...
      AND_MORE: '{names}, en {count} meer',
      SHOW_MORE: 'Meer tonen',
      SEE_ALL_CERTIFICATIONS: 'Bekijk alles',
      SEE_ALL_ECOSYSTEMS: 'Bekijk alles',
      ECOSYSTEMS: 'Ecosystemen',
      ECOSYSTEM_MEMBERS: '{count} {{lid|leden}}',
      ECOSYSTEM_MEMBERS_HEADING: 'Leden',
      ECOSYSTEM_ABOUT: 'Over',
      ECOSYSTEM_OWNER: 'Eigenaar van ecosysteem',
      ECOSYSTEM_COUNT: '{count} {{ecosysteem|ecosystemen}}',
    },
    SHARE_CREDENTIALS: {
