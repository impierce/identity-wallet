  ...
  ADD_CREDENTIALS: {
    ...
    EMAIL: {
      ...
      ADD: {
        ...
        LABEL: 'Hoe wilt u dit e-mailadres noemen?',
        LABEL_PLACEHOLDER: 'Persoonlijk e-mail',
        VALUE_LABEL: 'E-mail',
        VALUE_PLACEHOLDER: 'voornaam.achternaam@example.com',
        VALUE_PATTERN_ERROR: '',
        BUTTON_SEND: 'E-mail verzenden',
        BUTTON_SEND_AGAIN: 'E-mail opnieuw verzenden',
        CHECK_EMAIL: 'Controleer de inbox van je e-mail en voer de onderstaande code in.',
        EXPIRED_ERROR: '',
      },
    },
    PROFILE: {
      ...
      ADD: {
        ...
        MIDDLE_NAME_PLACEHOLDER: 'Je middelste naam',
