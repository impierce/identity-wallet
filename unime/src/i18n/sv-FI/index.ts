...
const sv_FI = {
  ...
  SCAN: {
    ...
    CONNECTION_REQUEST: {
      ...
      AND_MORE: '{names} och {count} till',
      SHOW_MORE: 'Visa mer',
      SEE_ALL_CERTIFICATIONS: 'Visa alla',
      SEE_ALL_ECOSYSTEMS: 'Visa alla',
      ECOSYSTEMS: 'Ekosystem',
      ECOSYSTEM_MEMBERS: '{count} {{medlem|medlemmar}}',
      ECOSYSTEM_MEMBERS_HEADING: 'Medlemmar',
      ECOSYSTEM_ABOUT: 'Om',
      ECOSYSTEM_OWNER: 'Ekosystemets ägare',
      ECOSYSTEM_COUNT: '{count} {{ekosystem|ekosystem}}',
    },
    SHARE_CREDENTIALS: {
