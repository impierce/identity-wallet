...
const fi_FI = {
  ...
  SCAN: {
    ...
    CONNECTION_REQUEST: {
      ...
      AND_MORE: '{names} ja {count} muuta',
      SHOW_MORE: 'Näytä lisää',
      SEE_ALL_CERTIFICATIONS: 'Näytä kaikki',
      SEE_ALL_ECOSYSTEMS: 'Näytä kaikki',
      ECOSYSTEMS: 'Ekosysteemit',
      ECOSYSTEM_MEMBERS: '{count} {{jäsen|jäsentä}}',
      ECOSYSTEM_MEMBERS_HEADING: 'Jäsenet',
      ECOSYSTEM_ABOUT: 'Tietoja',
      ECOSYSTEM_OWNER: 'Ekosysteemin omistaja',
      ECOSYSTEM_COUNT: '{count} {{ekosysteemi|ekosysteemiä}}',
    },
    SHARE_CREDENTIALS: {
