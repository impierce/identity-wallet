...
const de_DE = {
  ...
  SCAN: {
    ...
    CONNECTION_REQUEST: {
      ...
      AND_MORE: '{names}, und {count} weitere',
      SHOW_MORE: 'Mehr anzeigen',
      SEE_ALL_CERTIFICATIONS: 'Alle anzeigen',
      SEE_ALL_ECOSYSTEMS: 'Alle anzeigen',
      ECOSYSTEMS: 'Ökosysteme',
      ECOSYSTEM_MEMBERS: '{count} {{Mitglied|Mitglieder}}',
      ECOSYSTEM_MEMBERS_HEADING: 'Mitglieder',
      ECOSYSTEM_ABOUT: 'Über das Ökosystem',
      ECOSYSTEM_OWNER: 'Ökosystem-Inhaber',
      ECOSYSTEM_COUNT: '{count} {{Ökosystem|Ökosysteme}}',
    },
    SHARE_CREDENTIALS: {
  ...
  CREDENTIAL: {
    ...
    DETAILS: {
      ...
      OPEN_BADGES: {
        ...
        SKILL: 'Fähigkeit',
        OCCUPATION: 'Beruf',
        FRAMEWORK_LINK: 'Definition ansehen',
        CRITERIA: 'Kriterien',
        VALUE: 'Note',
      },
    },
