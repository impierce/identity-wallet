...
const en = {
  ...
  SCAN: {
    ...
    CONNECTION_REQUEST: {
      ...
      AND_MORE: '{names:string}, and {count:number} more',
      SHOW_MORE: 'Show more',
      SEE_ALL_CERTIFICATIONS: 'See all',
      SEE_ALL_ECOSYSTEMS: 'See all',
      ECOSYSTEMS: 'Ecosystems',
      ECOSYSTEM_MEMBERS: '{count:number} {{Member|Members}}',
      ECOSYSTEM_MEMBERS_HEADING: 'Members',
      ECOSYSTEM_ABOUT: 'About this Ecosystem',
      ECOSYSTEM_OWNER: 'Ecosystem Owner',
      ECOSYSTEM_COUNT: '{count:number} {{ecosystem|ecosystems}}',
    },
    SHARE_CREDENTIALS: {
