...
<div
  class={twMerge(
    'relative isolate flex h-[50px] items-center justify-between self-stretch bg-silver px-6 py-[13px] text-slate-800 [view-transition-name:top-nav-bar] dark:bg-navy dark:text-grey',
    $$props.class,
  )}
>
