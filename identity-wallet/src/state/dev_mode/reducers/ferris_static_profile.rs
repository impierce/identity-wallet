...
lazy_static! {
    pub static ref PERSONAL_INFORMATION: VerifiableCredentialRecord = {
        let mut record = VerifiableCredentialRecord::try_new(
            ...
            json!("eyJ0eXAiOiJ2YytzZC1qd3QiLCJhbGciOiJFZERTQSIsImtpZCI6ImRpZDprZXk6ejZNa2lkeHV3NG1tYXlRVXJndTRhbnVoS1A4blR3ZDlLTndrcG5RYUdoMnl5azJDI3o2TWtpZHh1dzRtbWF5UVVyZ3U0YW51aEtQOG5Ud2Q5S053a3BuUWFHaDJ5eWsyQyJ9..C0KblQqaDxQgZvcNUYwxs5Xx7sYxVPMaTcy3ryeeer5m6PlHTk2xu0fMMN715nqY2jZ6LMxaf8Pc2sl3GZiyAw~WyJ5d0FGWlBUdWdyQUdGalhlTmhaYWpnIiwgImdpdmVuTmFtZSIsICJGZXJyaXMiXQ~WyJxNWJhQjU5Y1dvMk1CaWx2ZnluZzNRIiwgImZhbWlseU5hbWUiLCAiQ3JhYm1hbiJd~WyJLak84LXl5c1RBVkRkNE82aFQxa2pBIiwgImVtYWlsIiwgImZlcnJpcy5jcmFibWFuQGNyYWJtYWlsLmNvbSJd~WyJhNVpreGI2WlFOLTZSYWRnRHpwSVFnIiwgImJpcnRoZGF0ZSIsICIxOTg1LTA1LTIxIl0~WyJMUDFaM2s5LVczS1htUzlLcUc5TnJRIiwgImNvdW50cnkiLCAiTkwiXQ~WyI3ZUUxbGJqNzVUcmRVSE1BREpCQ1lRIiwgImNvdW50cnlPZkJpcnRoIiwgIkRFIl0~WyJ6dWJFZnJUTWF5dGNDUGxsYjNOU2p3IiwgIm1lbWJlclNpbmNlIiwgIjIwMTktMTEtMDVUMTQ6MzA6MDBaIl0~"),
            vec![]
        ).unwrap();
        record.display_credential.id = "62326539-3634-6536-6131-323731373463".to_string();
    ...
    pub static ref OPEN_BADGE: VerifiableCredentialRecord = {
        let mut record = VerifiableCredentialRecord::try_new(
            CredentialFormats::JwtVcJson(()),
            json!("eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6ImRpZDpleGFtcGxlOjEyMyNrZXktMCJ9..uNxCghKfdSVWFDmPME-j_ebmQczxxcHsF2YuqDZ9BOfegGAAJoQpOV-HEJA35afhG_wzdTaiIJ4uVLUGV_u4ig"),
            vec![]
        ).unwrap();
    ...
    pub static ref EDU_BADGE: VerifiableCredentialRecord = {
        let mut record = VerifiableCredentialRecord::try_new(
            CredentialFormats::JwtVcJson(()),
            json!("eyJ0eXAiOiJKV1QiLCJhbGciOiJFZERTQSIsImtpZCI6ImRpZDprZXk6ejZNa3F5WmpEZmhzeVo1YzZOdUpoYm9zV2tTajg2Mmp5V2lDQ0tIRHpOTkttOGtoI3o2TWtxeVpqRGZoc3laNWM2TnVKaGJvc1drU2o4NjJqeVdpQ0NLSER6Tk5LbThraCJ9..z2rEuafNmbmY9sf5t4alnkZJeuNrNZrXXGovCc0J8NWdLyFU48mZfBffy6qltvtUOODOHSJnow1lAAFQ16W9Bw"),
            vec![]
        ).unwrap();
