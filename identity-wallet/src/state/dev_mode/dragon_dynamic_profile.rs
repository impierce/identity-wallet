use super::{actions::DevProfile, reducers::PASSWORD};
use crate::{
    command,
    error::AppError,
    state::{
        ...
        credentials::actions::{CredentialOffersSelected, CredentialsSelected},
        dev_mode::{DevMode, ProfileSteps},
        profile_settings::actions::CreateNew,
