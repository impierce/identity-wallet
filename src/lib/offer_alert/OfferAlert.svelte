                ...
                <div class="flex items-center">
                  ...
                  >
                    ...
                    <div class="break-all font-semibold">
                      <div>{JSON.stringify($state.current_user_prompt.credential_offer.credentials[i])}</div>
          ...
          <Button
            on:click={() =>
              dispatch({
                ...
                payload: { offer_indices: [...Array($state.current_user_prompt.credential_offer.credentials.length).keys()] }
              })}>{"Accept"}</Button
          >
        </AlertDialogAction>
      </AlertDialogFooter>
